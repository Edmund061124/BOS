/* ============================================================================
   ...
   directly below. Current values are the live BOS channels; replace them
   if the URLs ever change, e.g.:
   ...
   automatically — you never need to touch the dialog markup to update a
   link. If you change these URLs, also update the matching entries in
   index.html JSON-LD "sameAs" so search engines stay in sync.
   ============================================================================ */
